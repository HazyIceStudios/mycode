...
MY_USERNAME = "HazyIceStudios"  # Make sure you put your own username in here!
...
def show_repos(username: str, token: str) -> list:
    ...
    """
    url = f"https://api.github.com/users/HazyIceStudios/repos"
    headers = {"Authorization": f"token {token}"}
...
if __name__ == "__main__":
    ...
    create_repo("learning_oauth1", tkn)
